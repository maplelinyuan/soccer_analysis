...
coll_match_list = db.collection_names()     # 当前数据库所有集合名称
...
for coll_match_name in coll_match_list:
    ...
    for single_match_dict in coll.find():
        ...
        for single_company_id in match_company_id_list:
            ...
            company_coll_cursor = company_coll.find_one()  # 查询赔率信息
        ...
        if home_pro_diff > 0 or draw_pro_diff > 0 or away_pro_diff > 0:
            ...
            coll.update({"league_name": league_name}, {"support_direction": single_match_info_dict['support_direction']})